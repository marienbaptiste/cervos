 ...
 * Passes raw stereo to ring buffer for Opus encoding in main loop.
 */
                                    ...
                                    size_t size)
{
    ...
    /* Mix stereo to mono + downsample 2:1 for Opus encoding */
...
int usb_audio_init(void)
{
    ...
    LOG_INF("USB Audio initialized — 48kHz stereo → Opus");
    return 0;
}
